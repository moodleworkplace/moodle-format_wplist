...
Feature: Sections can be edited and deleted in wplist format
  ...
  Scenario: Edit the default name of the general section in wplist format
    ...
    Then I should see "This is the general section" in the "[data-region=section][data-section=0]" "css_element"
  ...
  Scenario: Edit section summary in wplist format
    ...
    Then I should see "Welcome to section 2" in the "[data-region=section][data-section=2]" "css_element"

  Scenario: Edit section default name in wplist format
    When I edit the wplist section "2" and I fill the form with:
      | Custom | 1                      |
      | New value for Section name      | This is the second topic |
    Then I should see "This is the second topic" in the "[data-region=section][data-section=2]" "css_element"
    And I should not see "Topic 2" in the "[data-region=section][data-section=2]" "css_element"

#  Scenario: Inline edit section name in wplist format
#    When I click on "Edit topic name" "link" in the "[data-region=section][data-section=1]" "css_element"
...
#    And I should see "Midterm evaluation" in the "[data-region=section][data-section=1]" "css_element"
...
#    And I should see "Midterm evaluation" in the "[data-region=section][data-section=1]" "css_element"
  ...
  Scenario: Deleting the middle section in wplist format
    ...
    And I should see "Test choice name" in the "[data-region=section][data-section=4]" "css_element"
    And I should see "Topic 4"
...
#    And I should see "Topic 6" in the "[data-region=section][data-section=6]" "css_element"
#    And "[data-region=section][data-section=7]" "css_element" should not exist
#    And I follow "Add sections"
#    And I set the field "Number of sections" to "3"
#    And I press "Add sections"
#    And I should see "Topic 7" in the "[data-region=section][data-section=7]" "css_element"
#    And I should see "Topic 8" in the "[data-region=section][data-section=8]" "css_element"
#    And I should see "Topic 9" in the "[data-region=section][data-section=9]" "css_element"
#    And "[data-region=section][data-section=10]" "css_element" should not exist
